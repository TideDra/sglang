...
| **Phi-3.5 Vision** | `microsoft/Phi-3.5-vision-instruct` | Phi-3.5 Vision combines a Phi-3.5 language decoder with a CLIP vision encoder and supports single- and multi-image understanding. | Use `--trust-remote-code`. |
